...
#define CC_MAP_RANGE(mapnumber) (mapnumber < MAP_INDEX_CHAOSCASTLE1 ? FALSE : ((mapnumber > MAP_INDEX_CHAOSCASTLE6 && mapnumber != MAP_INDEX_CHAOSCASTLE7) ? FALSE : TRUE))
...
} g_sttCHAOSCASTLE_LEVEL[MAX_CHAOSCASTLE_LEVEL] =
{
	...
	// Chaos Castle 2
	50, 119, // DK, DW, Elf, Sum
	30, 99, // MG, DL

	// Chaos Castle 3
	120, 179, // DK, DW, Elf, Sum
	100, 159, // MG, DL

	// Chaos Castle 4
	180, 239, // DK, DW, Elf, Sum
	160, 219, // MG, DL

	// Chaos Castle 5
	240, 299, // DK, DW, Elf, Sum
	220, 279, // MG, DL
...
static int g_iChaosCastle_EnterCost[MAX_CHAOSCASTLE_LEVEL]={25000, 80000, 150000, 250000, 400000, 650000, 900000};
...
{
	ITEMGET(14,13), 0, ITEMGET(14,14), 2,	// Chaos Castle 1
...
public:
	...
	int GetCCMap ( int iLevel )
	{
		if(iLevel == 6)
		{
			return MAP_INDEX_CHAOSCASTLE7;
		}
		else
		{
			return MAP_INDEX_CHAOSCASTLE1 + iLevel;
		}
	}

	int GetCCIndex ( int Map )
	{
		if(Map == 53) return 6;
		return Map - MAP_INDEX_CHAOSCASTLE1;
	}
