...
void EledoradoBoxOpenEven(LPOBJ lpObj, int boxtype,int addlevel,int money)
{
	...
	if ( EledoradoBox->GetBagCount() > 0 )
	{
		if ( (rand() % 100) < ItemDropRate )
		{
			...
			CItem NewItem;
			NewItem.Convert(type, Option1, Option2, Option3, 0, 1, 0, CURRENT_DB_VERSION,0);
...
void GoldMedalOpenEven(LPOBJ lpObj)
{
	...
	if ( GoldMedalItemBag->GetBagCount() > 0 )
	{
		if ( (rand()%20) < g_ItemDropRateForGoldMedal )
		{
			...
			EventItem.Convert(type, Option1, Option2, Option3, 0, 1, 0, 3,0);
...
void GameMasterBoxItemBagOpen(LPOBJ lpObj)
{
	GameMasterBoxEventItemBag->DropGameMasterBoxItem(lpObj->m_Index);
}
void GreenChaosBoxItemBagOpen(LPOBJ lpObj)
{
	GreenChaosBoxEventItemBag->DropGreenChaosBoxItem(lpObj->m_Index);
}
void RedChaosBoxItemBagOpen(LPOBJ lpObj)
{
	RedChaosBoxEventItemBag->DropRedChaosBoxItem(lpObj->m_Index);
}
void PurpleChaosBoxItemBagOpen(LPOBJ lpObj)
{
	PurpleChaosBoxEventItemBag->DropPurpleChaosBoxItem(lpObj->m_Index);
}
void ZaikanItemBagOpen(LPOBJ lpObj)
{
	ZaikanEventItemBag->DropZaikanItem(lpObj->m_Index);
}

void PhoenixItemBagOpen(LPOBJ lpObj)
{
	PhoenixEventItemBag->DropPhoenixItem(lpObj->m_Index);
}

void MedusaItemBagOpen(LPOBJ lpObj)
{
	MedusaEventItemBag->DropMedusaItem(lpObj->m_Index);
}

void HellMainItemBagOpen(LPOBJ lpObj)
{
	HellMainEventItemBag->DropHellMainItem(lpObj->m_Index);
}

void SantaClausItemBagOpen(LPOBJ lpObj)
{
	SantaClausEventItemBag->DropSantaClausItem(lpObj->m_Index);
}
