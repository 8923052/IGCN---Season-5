...
public:
	...
	void Initialize();
	LPITEMEFFECT GetCurrentEffectType(LPOBJ lpObj, int effectpos);
	...
	bool PrevSetItemLastEffectForBlossoms(LPOBJ lpObj);
	bool NextSetItemLastEffectForBlossoms(LPOBJ lpObj);
	...
	bool ClearItemEffect(LPOBJ lpObj, int iEffectOption, int EffectPos);
	bool ClearItemEffect2(LPOBJ lpObj, int iItemIndex, int iEffectOption);
	bool SearchItemEffectType(int iItemNumber, int* iEffectType1, int* iEffectType2, int* iEffectValidTime, int* OptionType);
	bool SearchItemEffectType2(int iItemNumber);
