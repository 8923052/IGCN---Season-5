/////////////////////////////////
//  ItemSocketSystem.h
#ifndef SOCKETITEMSYSTEM_H
#define SOCKETITEMSYSTEM_H
...
public:
	...
	void ApplyEffect( int aIndex);

	void CalcEffect(BYTE option,struct ITEM_SOCKET_EFFECT* lpEffect);

	bool IsSeason4Item(int index);

	void SeedExtract(int aIndex);
	void SeedSphere(int aIndex);
	void SeedCalc(int aIndex,BYTE info);
	void NewMix4(int aIndex,BYTE info);
