...
#define	INTERNATIONAL_KOREA		0x00	// 한국어
#define INTERNATIONAL_JAPAN		0x01	// Japan >.<
#define	INTERNATIONAL_TAIWAN	0x03	// 대만어
#define	INTERNATIONAL_CHINA		0x04	// 중국어
#define INTERNATIONAL_INFO	INTERNATIONAL_KOREA

#if(INTERNATIONAL_INFO == INTERNATIONAL_JAPAN)
	#define MOVE_PROTOCOL		0x1D//JAPAN
	...
	#define MOVE_PROTOCOL		0xD7//CHINA
	...
	#define MOVE_PROTOCOL		0xD3//KOREA
...
void GCMagicListOneSend(int aIndex, char Pos, WORD type, unsigned char level, unsigned short skill, BYTE btListType);
...
void GCSkillKeySend(int aIndex, unsigned char* keybuffer, unsigned char GO, unsigned char Qk, unsigned char Wk, unsigned char Ek, unsigned char Rk,/*<regrel ebp+0x20>*/ /*|0x1|*/ unsigned char ChatWnd, int QWERLevel);
...
void GCStateInfoSend(OBJECTSTRUCT* lpObj, BYTE state, int Effect);
