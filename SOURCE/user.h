...
#define OBJ_MAXMONSTER 11500 //5800
...
enum VIEWSKILLSATE_INFO {
	ST_EMPTY			= 0,
	ST_INCREASE_ATTACK	= 1,
	ST_INCREASE_DEFENSE = 2,
	ST_HELP_BUFF		= 3,	// Elf Soldier Buff
	ST_MANASHIELD		= 4,
	ST_CRITICALDMG		= 5,	// DL Increase Critical Damage
	ST_INFINITYARROW	= 6,
	ST_AGSKILL			= 7,	// Unknow AG Skill
	ST_INCREASE_LIFE	= 8,	// DK Skill, Increase life
	ST_CASTLESIEGE1		= 9,	// HUH?
	ST_POTION_BLESS		= 10,	// Potion of bless
	ST_POTION_SOUL		= 11,	// Potion of soul
	ST_UNKNOW_SKILL1	= 12,	// hmm?
	ST_UNKNOW_SKILL2	= 13,
	ST_NEW_SKILL1		= 14,	// I don't know :|
	ST_NONE				= 15,
	ST_NEW_SKILL2		= 16,	// Same as ST_NEW_SKILL1 but lvl 2 
	ST_NEW_SKILL3		= 17,	// Same as ST_NEW_SKILL1 but lvl 3
	ST_TRANSPERMENT		= 18,	// Invisible Character with Blue glow
	ST_UNKNOW_SKILL3	= 19,
	ST_UNKNOW_SKILL4	= 20,
	ST_WOLF_SKILL1		= 21,	//Rare thing
	ST_WOLF_SKILL2		= 22,
	ST_WOLF_SKILL3		= 23,
	ST_WOLF_SKILL4		= 24,
	ST_WOLF_SKILL5		= 25,
	ST_WOLF_SKILL6		= 26,
	ST_INVISIBLE	= 27,	// Make u invisible :|
	ST_GAMEMASTER		= 28,
	ST_BLUE_GEM			= 29,	// Cash Shop?
	ST_VIOLET_GEM		= 30,	// Cash Shop?
	ST_YELLOW_GEM		= 31,
	ST_UNKNOW_SKILL6	= 32,
	ST_UNKNOW_SKILL7	= 33,
	ST_MAGICCIRCLE		= 34,	// New DW Skill
	ST_HALOWEEN_GREEN	= 35,
	ST_HALOWEEN_ORANGE	= 36,
	ST_HALOWEEN_VIOLET	= 37,
	ST_HALOWEEN_RED		= 38,
	ST_HALOWEEN_BLUE	= 39,
	ST_BLUE_GEM2		= 40,	// Same as ST_BLUE_GEM, lvl 2?
	ST_VIOLET_GEM2		= 41,	// Same As ST_VIOLET_GEM, lvl 2?
	ST_YELLOW_GEM2		= 42,	// ...
	ST_RED_GEM			= 43,
	ST_LEFT_ARROW		= 44,	// I DON'T KNOW :|
	ST_REDSHIELD		= 45,	// IT'S STRANGE
	ST_REDAXE			= 46,
	ST_REDUNK			= 47,
	ST_GREEN_UNK		= 48,	// ADD LIFE?
	ST_GREEN_UNK2		= 49,	// IT'S LIKE A "M" LOL
	ST_GREEN_POTION		= 50,
	ST_YELLOW_POTION	= 51,
	ST_RED_POTION		= 52,
	ST_BLUE_POTION		= 53,
	...
	ST_ICESKILL			= 56,
	ST_ICEARROWSKILL	= 57,
	ST_FIRESLASHSKILL	= 58,
	ST_UNKNOW_SKILL8	= 59,
	ST_UNKNOW_SKILL9	= 60,
	ST_UNKNOW_SKILL10	= 61,	// I need the name
	ST_UNKNOW_SKILL11	= 62,
	ST_UNKNOW_SKILL12	= 63,
	ST_UNKNOW_SKILL13	= 64,
	ST_UNKNOW_SKILL14	= 65,	// i need the name
	ST_UNKNOW_SKILL15	= 66,
	ST_UNKNOW_SKILL16	= 67,
	ST_UNKNOW_SKILL17	= 68,
	ST_UNKNOW_SKILL18	= 69,
	ST_UNKNOW_SKILL19	= 70,
	ST_UNKNOW_SKILL20	= 71,	// i need the name
	ST_SLEEPSKILL		= 72,	// Summoner Sleep
	ST_NEWDLSKILL		= 73,
	ST_NEILSKILL		= 74,
	ST_SAHAMUTSKILL		= 75,
	ST_MAGICSPEEDUP		= 76,
	ST_MAGICDEFENSEUP	= 77,
	ST_UNK_FLOWER1		= 78,
	ST_UNK_FLOWER2		= 79,
	ST_UNK_FLOWER3		= 80,
	ST_DUELINTERFACE = 98,
...
enum MAP_INDEX
{
	...
	MAP_INDEX_ILLUSION_TEMPLE6 = 0x32,
...
struct SKILL_INFO
{
	...
	char	IceType;
	int		SkillAddLife;
	int		WizardDefenseVal;
	short	SantaBlessingVal;
	short	SantaProtectionVal;
	short	SantaHealingVal;
	short	SantaDefenceVal;
	short	SantaQuicknessVal;
	short	SantaStrengthVal;
	short	SantaFortuneVal;
	short	MagicCircleVal;
	short	DamageRefVal;
	short	SwordPowerIncVal;
	short	SwordPowerDecVal;
	short	SahamuttDamage;
	short	NeilDamage;
	BYTE	GhostPhantomX;
	BYTE	GhostPhantomY;
	short	GladiatorBuffVal;
	short	DecDamageValue;
	short	DecDefenseValue;
	short	SleepTime;
};
...
struct OBJECTSTRUCT
{
	...
	WORD m_ImmuneToMagicCount;	// 249
	WORD m_ImmuneToHarmCount;	// 24A
	...
	int GuildNumber;	// 2D0
	unsigned char GensNumber;
	unsigned char GensPosition;
	int	GensExp;
	int GensNextExp;
	int GensRank;
	bool GensReward;
	...
	int m_iPeriodItemEffectIndex[10];	// 195C
	WORD m_wExprienceRate;	// 1960
	WORD m_wMasterExperienceRate;	// 1960
	WORD m_wItemDropRate;	// 1962
	BYTE m_btMoveMapBound;	// 1964
	WORD m_uMasterLevel;
	WORD m_uMasterPoints;
	__int64 m_uMasterExp;
	__int64 m_uMasterNextExp;
	BYTE m_BuffEffect;
	BYTE m_iDuelRoom;
  ...
  char m_cIllusionTempleTeam;
  int PCPoints;
  DWORD PCPointsTime;
  int m_PeriodItemTime;
  BYTE m_btSealIndex;
  BYTE m_btDoubleGoerRoom;
  DWORD m_dwDGTimeleft;
  BYTE VipType;
  int m_iVipExpAdd;
  int m_iVipDropAdd;
...
//  /*<thisrel this+0x156c>*/ /*|0x4|*/ int m_iAccumulatedCrownAccessTime;
  BYTE m_btWareHouseId;
  ITEM_SOCKET_EFFECT ItemSocketEffect;
    int m_SummonerSkillSleep;
  	int m_SummonerSkillSleepTime;
	int m_SummonerSkillReflex;
	int m_SummonerSkillReflexTime;
	int m_SummonerSkillInnovationTime;
	int m_SummonerSkillWeaknessTime;
	int m_SummonerSkillSwordPower;
	int m_SummonerSkillSwordPowerTime;
	int m_iSkillSahamuttAttacker;
	int m_iSkillSahamuttDamage;
	int m_iSkillSahamuttTime;
	MASTER_SKILL_TREE_EFFECT MasterSkillTreeEffect;
	SKILL_INFO m_SkillInfo;
	int m_GladiatorGloryBuffTime;
	int m_iSkillPollusionX;
	int m_iSkillPollusionY;
	SUPPORT_QUEST_INFO SupportQuestInfo;
	int m_iIllusionShieldTime;
	int m_iIllusionFreezeTime;
	int	m_ServerTimeTick;
	int m_SkillStormTime;
	int m_iSkillParalyzeTime;
	int m_SkillFlameStrikeTime;
	int m_iSkillRageulTime;
	int m_iSkillShockTime;
	int m_iSkillSleepTime;
	int m_iSkillDamageDecTime;
	int m_iSkillDamageDecValue;
	int m_iSkillDefenseDecTime;
	int m_iSkillDefenseDecValue;
	int m_iResets;
};
...
public:
	...
	BOOL SetBill(BYTE certify_type, BYTE pay, DWORD end_time, char* ends_days)	// line : 228
	{
		...
		strcpy_s(this->EndsDays, ends_days);
		return bRet;
	}	// line : 237
