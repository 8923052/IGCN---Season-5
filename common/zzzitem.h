...
#define DBI_GET_SOCKET1(x) ( ((x) & 0x08) << 4  )
#define DBI_GET_SOCKET2(x) ( ((x) & 0x08) << 4  )
#define DBI_GET_SOCKET3(x) ( ((x) & 0x08) << 4  )
#define DBI_GET_SOCKET4(x) ( ((x) & 0x08) << 4  )
#define DBI_GET_SOCKET5(x) ( ((x) & 0x08) << 4  )
...
public:
	...
	void Convert(int type, BYTE Option1, BYTE Option2, BYTE Option3,BYTE Attribute2, BYTE SetOption, BYTE ItemEffectEx, BYTE DbVersion, BYTE* SOCKETOPT);
	void Value();
	void OldValue();
